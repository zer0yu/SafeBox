 ...
 ******************************************************************************/
package com.mxn.soul.flowingdrawer.secretshare.cli;

import android.os.Environment;

import com.mxn.soul.flowingdrawer.secretshare.engine.SecretShare;
import com.mxn.soul.flowingdrawer.secretshare.engine.SecretShare.PublicInfo;
import com.mxn.soul.flowingdrawer.secretshare.engine.SecretShare.ShareInfo;
import com.mxn.soul.flowingdrawer.secretshare.exceptions.SecretShareException;
import com.mxn.soul.flowingdrawer.secretshare.math.BigIntUtilities;
...
public class MainCombine
{
    ...
    public static class CombineOutput
    {
        ...
        public void print(PrintStream out)
        {
            ...
            File file2=new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/password/");
            if(!file2.exists()){
            	file2.mkdirs();
            }
            File file1=new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/password/se2.txt");
    		FileWriter writer1;
			try {
				writer1 = new FileWriter(file1);
				String key1= String.valueOf(secret);
				writer1.write(key1);
			    writer1.close();
			} catch (IOException e) {
