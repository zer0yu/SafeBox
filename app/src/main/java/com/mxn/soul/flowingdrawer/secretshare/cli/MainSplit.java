...
import com.mxn.soul.flowingdrawer.main.Makechoice;
...
import com.mxn.soul.flowingdrawer.secretshare.engine.SecretShare.SplitSecretOutput;
...
//            }
                                 ...
                                 boolean printAsBigIntCs)
        {
            ...
            String name="-s"+i+".txt";
			File file=new File(Makechoice.Key_Phonepath+name);	   //�����Ƭ��·��
			if(!file.exists()){
				try {
					file.createNewFile();
				} catch (IOException e) {
