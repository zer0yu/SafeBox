...
import com.mxn.soul.flowingdrawer.secretshare.math.EasyLinearEquationUT;
    ...
    extends TestCase
{
 ...
 // ==================================================
    ...
    private void subtestMassiveLoop(final BigInteger prime)
    {
        ...
        for (int i = 0; i < trials; i++)
        {
            ...
            else
            {
                ...
                secret = BigIntUtilities.Human.createBigInteger(s);
            }
    ...
    private void subtestDuplicateSharesReconstruction(List<ShareInfo> shares)
    {
        ...
        List<ShareInfo> usetheseshares =
            new ArrayList<ShareInfo>();
     ...
     * @return secret
     */
    private BigInteger subtestReconstruction(List<ShareInfo> shares)
    {
        if (true)
        {
